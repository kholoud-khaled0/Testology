  ...
  questions: [
    {
      ...
      correctIndex: 2,
      explanation:
        "The front-end is the user-facing interface for entering commands and queries.",
    },
    {
      id: "q-2",
      code: "EX-4-2",
      ...
      correctIndex: 1,
      explanation:
        "The back-end manages authentication, data access, prompt preparation, and LLM interaction.",
    },
    {
      id: "q-3",
      code: "EX-4-3",
      ...
      correctIndex: 1,
      explanation:
        "LLM-powered tools generate insights dynamically using contextual data.",
    },
    {
      id: "q-4",
      code: "EX-4-4",
...

    {
      ...
      correctIndex: 1,
      explanation:
        "Post-processing validates and aligns responses with test conditions.",
    },
    {
      id: "q-7",
      code: "EX-4-7",
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation:
        "LLMs provide reasoning capabilities beyond standard architectures.",
    },
